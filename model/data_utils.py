...
class TrainingDataset(object):
    ...
    def process(self, corpus, record_name, workers=4, max_queue_size=500):
...
#     trump_path = "./model/data/trump.csv"
#     biden_path = "./model/data/biden.csv"
...
#     corpus_trump = pd.read_csv(trump_path, engine='python', usecols=['content']).values.tolist()
#     corpus_biden = pd.read_csv(biden_path, engine='python', usecols=['tweet']).values.tolist()
...
#     TD.process(
#         corpus=corpus_trump,
#         record_name='./model/corpus_tfrecord/corpus_trump.tfrecord',
#     )

#     TD.process(
#         corpus=corpus_biden,
#         record_name='./model/corpus_tfrecord/corpus_biden.tfrecord',
#     )
